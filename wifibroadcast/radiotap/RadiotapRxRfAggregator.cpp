...
std::string RadiotapRxRfAggregator::card_key_rf_indicators_to_string(
  ...
  return fmt::format("RxRfStats[Adapter: {}:{}:{} | Antenna1: {}:{}:{} | Antenna2: {}:{}:{}]",indicators.adapter.rssi_dbm,indicators.adapter.noise_dbm,indicators.adapter.card_signal_quality_perc,
