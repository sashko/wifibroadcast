...
class Ieee80211Header {
 public:
  ...
  std::array<uint8_t, SIZE_BYTES> data = {
      ...
      0x13, 0x22, 0x33, 0x44, 0x55, 0x66, // something MAC ( 6 bytes), I think SRC MAC - last byte is used as radio port
      0x13, 0x22, 0x33, 0x44, 0x55, 0x66, // something MAC ( 6 bytes), I think DEST MAC - last byte is als used as radio port
